...
<div class="w-full">
    <div class="max-w-6xl mx-auto">
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('agent.locataires.reassign_process', $locataire->id) }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
                ...
                <div class="space-y-8">
                    ...
                    <div class="p-4 bg-blue-50 rounded-2xl border border-blue-100 flex items-start gap-3">
                        ...
                        <p class="text-xs text-blue-700 font-bold leading-relaxed">
                            ...
                            En lui attribuant un nouveau bien, il redeviendra un locataire actif dans votre liste principale.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        @error('bien_id') <p class="text-red-500 text-[10px] mt-2 font-bold">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @if($locataire->contrat_bail)
                            <p class="text-[9px] text-gray-400 mt-2 italic font-bold">Note: Si vous n'ajoutez rien, l'ancien contrat sera conservé.</p>
                        @endif
                    </div>
                </div>

                <div class="mt-12 flex justify-end gap-4">
                    <a href="{{ route('agent.locataires.moved_out') }}" class="px-8 py-4 rounded-2xl bg-gray-100 text-gray-500 font-black text-xs uppercase tracking-widest hover:bg-gray-200 transition-all">
                        Retour
                    </a>
