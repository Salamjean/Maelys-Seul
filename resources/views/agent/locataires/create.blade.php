...
<div class="w-full">
    <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('agent.locataires.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="w-full px-5 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-secondary focus:bg-white outline-none transition-all font-bold text-sm" placeholder="Ex: KOUASSI">
                        @error('name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1">Prénoms</label>
                        <input type="text" name="prenoms" value="{{ old('prenoms') }}" required class="w-full px-5 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-secondary focus:bg-white outline-none transition-all font-bold text-sm" placeholder="Ex: Jean Marc">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" class="w-full px-5 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-secondary focus:bg-white outline-none transition-all font-bold text-sm" placeholder="client@exemple.com">
                    ...
                    <div>
                        ...
                        <input type="text" name="contact" value="{{ old('contact') }}" required class="w-full px-5 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-secondary focus:bg-white outline-none transition-all font-bold text-sm" placeholder="07 00 00 00 00">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="profession" value="{{ old('profession') }}" required class="w-full px-5 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-secondary focus:bg-white outline-none transition-all font-bold text-sm" placeholder="Ex: Informaticien">
                    ...
                    <div>
                        ...
                        <textarea name="adresse" required rows="3" class="w-full px-5 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-secondary focus:bg-white outline-none transition-all font-bold text-sm" placeholder="Quartier, Rue...">{{ old('adresse') }}</textarea>
                    ...
                    <div>
                        ...
                        @endif
                        @error('bien_id') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-6 bg-orange-50/50 rounded-3xl border border-orange-100">
                        ...
                        <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
                            <div>
                                ...
                                @error('piece_identite') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('contrat_bail') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>
                        </div>
                    </div>
