    ...
    <div class="mx-auto h-full" style="width:90%">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                ...
                <nav class="flex mt-2 text-sm text-gray-500" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="{{ route('admin.dashboard') }}" class="hover:text-secondary transition-colors">Tableau de bord</a>
                        </li>
                        <li>
                            <div class="flex items-center">
                                <i class="fa-solid fa-chevron-right text-[10px] mx-1"></i>
                                <a href="{{ route('admin.biens.index') }}" class="hover:text-secondary transition-colors">Biens</a>
                            </div>
                        </li>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.biens.edit', $bien->id) }}" 
