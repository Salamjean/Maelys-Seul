...
@section('content')
    ...
    <div style="background:white; padding:20px; border-radius:14px; margin-bottom:24px; box-shadow:0 1px 4px rgba(0,0,0,0.06);">
        <form action="{{ route('admin.biens.index') }}" method="GET" style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap:15px; align-items:end;">
            <div>
            ...
            <div style="display:flex; gap:10px;">
                ...
                <a href="{{ route('admin.biens.index') }}" style="padding:10px; background:#f3f4f6; color:#374151; border-radius:8px; text-decoration:none; display:flex; align-items:center; justify-content:center;">
                            ...
                            <tr style="border-bottom:1px solid #f3f4f6; transition:background 0.15s;"
                                ...
                                <td style="padding:12px 16px; text-align:center;">
                                    <div style="display:flex; justify-content:center; gap:8px;">
                                        @if($bien->statut !== 'loue')
                                            <a href="{{ route('admin.locataires.create', ['bien_id' => $bien->id]) }}" title="Ajouter un locataire"
                                        ...
                                        @endif
                                        <a href="{{ route('admin.biens.show', $bien->id) }}" title="Voir"
                                            ...
                                            onmouseover="this.style.background='#e5e7eb'"><i class="fa-solid fa-eye"
                                                style="font-size:14px;"></i></a>
                                        <a href="{{ route('admin.biens.edit', $bien->id) }}" title="Modifier"
                                        ...
                                        <form action="{{ route('admin.biens.destroy', $bien->id) }}" method="POST" id="delete-form-{{ $bien->id }}" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
