...
@section('content')
<div class="" x-data="{ 
    activeTab: localStorage.getItem('activePaymentTabComptable') || 'mobile',
    switchTab(newTab) {
        this.activeTab = newTab;
        localStorage.setItem('activePaymentTabComptable', newTab);
    }
}">
    {{-- Header --}}
    <div class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        {{-- Barre de Recherche --}}
        <form action="{{ route('comptable.payments.history') }}" method="GET" class="flex items-center gap-3 w-full md:w-auto">
            <div class="relative w-full md:w-96 group">
                ...
                @if(request('search'))
                    <a href="{{ route('comptable.payments.history') }}" class="absolute right-5 top-1/2 -translate-y-1/2 text-gray-300 hover:text-red-500 transition-colors">
