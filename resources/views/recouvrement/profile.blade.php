...
@section('title', 'Mon Profil - Recouvrement')
...
<div class="max-w-7xl mx-auto space-y-8 pb-12">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-400 font-bold uppercase text-[10px] tracking-[2px] mt-1">Gérez vos informations d'agent de recouvrement</p>
        </div>
    ...
    <form action="{{ route('recouvrement.profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
