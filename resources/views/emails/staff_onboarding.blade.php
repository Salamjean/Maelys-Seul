...
<body>
    <div class="container">
        <div class="header">
            ...
            <p style="margin-top: 10px; opacity: 0.8; font-weight: 600; text-transform: uppercase; letter-spacing: 2px; font-size: 11px;">Accès Collaborateur ({{ $member->role === 'comptable' ? 'Comptabilité' : 'Recouvrement' }})</p>
        </div>
        <div class="content">
            <h2 style="font-weight: 800; color: #02245b;">Bienvenue dans l'équipe, {{ $member->name }} !</h2>
            <p>Un compte <strong>{{ $member->role === 'comptable' ? 'Comptable' : 'Agent de Recouvrement' }}</strong> a été créé pour vous sur la plateforme <strong>MAELYS-IMO</strong>.</p>
