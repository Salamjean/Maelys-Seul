...
class LocataireController extends Controller
{
    ...
    public function edit(User $locataire)
    {
        ...
        return view('agent.locataires.edit', compact('locataire', 'biens'));
    }
    ...
    public function update(Request $request, User $locataire)
    {
        ...
        return redirect()->route('agent.locataires.index')->with('success', 'Dossier locataire mis à jour avec succès.');
    }
    ...
    public function reassign(User $locataire)
    {
        ...
        return view('agent.locataires.reassign', compact('locataire', 'biens'));
    }
    ...
    public function processReassign(Request $request, User $locataire)
    {
        ...
        $data = [
            ...
            'moved_out_at' => null, // On réactive le locataire
            'contract_start_date' => now(),
        ];

        // Mettre à jour le contrat si nouveau fichier
        ...
        return redirect()->route('agent.locataires.index')->with('success', 'Le locataire a été ré-assigné avec succès au bien ' . $bien->reference);
    }
    ...
    public function moveOut(Request $request, User $locataire)
    {
        ...
        // Marquer comme ayant déménagé
        $locataire->update([
            'moved_out_at' => now(),
            'bien_id' => null
        ]);

        return redirect()->route('agent.locataires.index')->with('success', 'Le déménagement a été enregistré. Le bien est à nouveau disponible.');
    }
